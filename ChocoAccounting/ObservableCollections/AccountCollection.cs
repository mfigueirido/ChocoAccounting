...
namespace ChocoAccounting.ObservableCollections
{
    public class AccountCollection
        : ExpandedCollection<Account>
    {
        public AccountCollection(IEnumerable<Account> accounts, MovementsModel context)
            : base(accounts, context)
        {
            Context = context;
        }
        ...
        {
            Context.AccountSet.Add(item);
            base.InsertItem(index, item);
        }

        protected override void RemoveItem(int index)
        {
            Context.AccountSet.Remove(this[index]);
